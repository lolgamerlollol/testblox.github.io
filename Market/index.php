...
<div class="roblox-item-image image-small" data-item-id="2145" data-image-size="small" data-is-static=""><div style="position: relative; overflow: hidden;"><a href="/Market/Items/?id=<?echo "$gI->id"; ?>"><img title="<?echo "$gI->name"; ?>" alt='<?echo "$gI->name"; ?>' class="original-image modal-thumb" src="<?echo "$gI->image"; ?>" width="110" height="110" border="0"></a></div></div>
<div id="textDisplay">
<div class="CatalogItemName notranslate"><a class="name notranslate" href="/Market/Items/?id=<?echo "$gI->id"; ?>" title="<?echo "$gI->name"; ?>"><?echo "$gI->name"; ?></a></div>
<span class="tickets " data-se="item-priceintickets"><? echo " $gI->price"; ?></span>
</div>
<div class="CatalogHoverContent">
<div><span class="CatalogItemInfoLabel">Creator:</span> <span class="HoverInfo notranslate"><a href="/Profile/?username=<? echo "$gI->creator"; ?>"><? echo " $gI->creator"; ?></a></span></div>
