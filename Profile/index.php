...
<img src="https://rhodum.xyz/img/admin.png" alt="OBC" title="OBC member" border="0"></div>
...
<div id="ctl00_cphRoblox_OBCmember" class="blank-box" style="margin-top: 10px; width: 951px; float: left; padding: 8px">
<div style="float: left; margin-right: 10px;">
<img src="https://rhodum.xyz/img/dev.png" alt="OBC" title="OBC member" border="0"></div>
<div style="float: left; line-height: 30px;">
...
<br>
<a href="/Profile/?username=<? echo $gU->username;?>">http://rhodum.xyz/Profile/?username=<? echo $gU->username;?></a>
</div>
</div>
<div>
<div>
...
<a id="MessageButton" style="margin:0 5px" class="GrayButton " href="Message?id=<? echo $id ?>">Send Message</a>
</div>
