...
try {
	$handler = new PDO('mysql:host=pluspower.mysql;dbname=pluspower_rhodum', 'pluspower_bukan', 'BukanPass2');
...
$conn = mysql_connect("pluspower.mysql", "pluspower_bukan", "BukanPass2");
mysql_select_db("pluspower_rhodum");
